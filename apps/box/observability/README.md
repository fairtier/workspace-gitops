...
[../apps/values.yaml](../apps/values.yaml) `alloyChartVersion`, the same
...
[../apps/templates/observability.yaml](../apps/templates/observability.yaml):
...
verification, alert rules): [apps/box/README.md — Fleet telemetry](../README.md#fleet-telemetry-alloy--central).
